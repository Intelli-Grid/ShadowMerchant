    ...
    <main className="flex-1 w-full flex flex-col items-center">
      ...
      <section className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Link href="/deals" className="bg-[#FF6B00] hover:bg-[#E66000] text-white font-bold py-4 px-8 rounded-lg shadow-lg shadow-[#FF6B00]/20 transition-all hover:scale-105 active:scale-95">
            Browse All Deals
          </Link>
      ...
      <section className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/deals" className="text-sm font-semibold text-gray-400 hover:text-white transition-colors">
            View All →
          </Link>
        </div>
