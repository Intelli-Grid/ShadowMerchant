  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 border-t border-slate-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-20 mt-16">
        ...
        {/* WhatsApp Exit CTA — catch users before they bounce */}
        <div className="mt-16 text-center max-w-2xl mx-auto px-4 pb-12">
          ...
          <p className="text-slate-500 text-xs mb-6">
            Get daily deal picks on WhatsApp before they expire — it&apos;s free.
          </p>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <a
              href="https://wa.me/919152952052?text=Hi%21%20I%20just%20saw%20the%20deals%20I%20missed.%20Send%20me%20today%27s%20picks%20%F0%9F%94%A5"
              target="_blank"
              rel="noopener noreferrer"
